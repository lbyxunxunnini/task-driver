...
require_match '30 秒选择器' SKILL.md
...
require_match '有瑕疵' references/quick-start.md
require_match '高风险复核' references/quick-start.md
